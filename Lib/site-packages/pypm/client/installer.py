...
from pypm.client import depgraph, error
...
class PyPMDepGraph(depgraph.DepGraph):
    ...
    def add_requirement(self, *a, **kw):
        try:
            return super(PyPMDepGraph, self).add_requirement(*a, **kw)
        except depgraph.RequirementNotFound as e:
            raise error.PackageNotFound(e._requirement, e._required_by)
